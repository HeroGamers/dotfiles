{ pkgs, ... }:
{
  ...
  programs.neovim = {
    ...
    plugins =
      ...
      let
        # Might need "packadd! <plugin>\n" in the start of the config
        # toLua = str: "lua << EOF\n${str}\nEOF\n";
      ...
      [
        ...
        # I also quite like the default plugins from NVChad
        ...
        # Stuff from https://github.com/nix-community/kickstart-nix.nvim
